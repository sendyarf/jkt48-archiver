...
export const metadata: Metadata = { title: 'Tentang & Privasi | JKT48 Live Archive' };
export default function AboutPage() {
  return <article className="container page-section prose"><p className="eyebrow">TENTANG SITUS</p><h1>Arsip untuk komunitas</h1><p>JKT48 Live Archive merupakan katalog komunitas untuk menelusuri siaran ulang. Situs ini tidak berafiliasi dengan JKT48, IDN, Showroom, atau YouTube. Hak atas konten tetap dimiliki pemiliknya.</p>
