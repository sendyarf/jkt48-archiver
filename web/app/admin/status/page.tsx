...
export default async function SystemPage() {
  ...
  return <section><div className="section-heading"><div><p className="eyebrow">OPERASIONAL · PRIVATE</p><h1>Sistem & antrean</h1><p>Data diambil dari database saat halaman ini dibuka — bukan penanda bot sedang jalan atau tidak.</p></div></div>
