...
import { AUTO_PUBLISH_AFTER_HOURS, getPublications, setPublication } from '@/lib/db';
...
export async function GET(request: Request) {
  ...
  try { return json({ success: true, autoPublishAfterHours: AUTO_PUBLISH_AFTER_HOURS, ...getPublications(params.get('q') || '', page) }); }
